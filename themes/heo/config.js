const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-12-15', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.kk218.com' },
    { title: '访问蜗牛博客图库', url: 'https://img.kk218.com/' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '停息挂账',
  HEO_HERO_TITLE_2: '与债务认知',
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '黑户贷款', url: '/tag/黑户贷款' },
  ...
  HEO_INFO_CARD_URL2: 'https://github.com/netput-web',
  ...
  HEO_SOCIAL_CARD_URL: 'https://blog.kk218.com/shequn',

  // 底部统计面板文案
  HEO_POST_COUNT_TITLE: '文章数量:',
  HEO_SITE_TIME_TITLE: '建站天数:',
  HEO_SITE_VISIT_TITLE: '访问数量:',
  HEO_SITE_VISITOR_TITLE: '访客数量:',
